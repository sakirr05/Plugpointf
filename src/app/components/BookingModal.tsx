...
import type { Charger, Booking } from "../data/mock-data";
...
const dates = [
  { day: "Wed", date: "Feb 18", full: "Feb 18, 2026" },
  { day: "Thu", date: "Feb 19", full: "Feb 19, 2026" },
  { day: "Fri", date: "Feb 20", full: "Feb 20, 2026" },
  { day: "Sat", date: "Feb 21", full: "Feb 21, 2026" },
  { day: "Sun", date: "Feb 22", full: "Feb 22, 2026" },
  { day: "Mon", date: "Feb 23", full: "Feb 23, 2026" },
  { day: "Tue", date: "Feb 24", full: "Feb 24, 2026" },
];
      ...
      <div className="relative bg-white w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-border px-4 py-3 flex items-center justify-between z-10">
          {step !== "datetime" && step !== "confirmation" ? (
            <button
              onClick={() =>
                setStep(step === "payment" ? "datetime" : "payment")
              }
            >
          ...
          <div className="p-4">
            ...
            <div className="flex items-center gap-3 p-3 bg-secondary rounded-xl mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-[0.6875rem] text-muted-foreground">
                  {charger.connectorType} - {charger.power} kW
                </p>
              </div>
            ...
            <div className="flex gap-2 overflow-x-auto no-scrollbar mb-4">
              {dates.map((d) => (
                <button
                  ...
                  className={`flex flex-col items-center px-3 py-2 rounded-xl min-w-[3.5rem] transition-colors ${
            ...
            <div className="flex items-center gap-3 mb-4">
              <button
                ...
                className="w-8 h-8 rounded-lg bg-muted flex items-center justify-center text-[1.125rem]"
              >
                -
              </button>
              <span className="text-[1.25rem] w-8 text-center" style={{ fontWeight: 700 }}>
                {duration}
              </span>
              <button
            ...
            <div className="p-3 bg-muted rounded-xl mb-4">
              <div className="flex justify-between text-[0.8125rem] mb-1">
                <span className="text-muted-foreground">
                  ₹{charger.pricePerHour} x {duration} hr
                  {duration > 1 ? "s" : ""}
                </span>
                <span>₹{subtotal}</span>
              </div>
          ...
          <div className="p-4">
            ...
            <div className="p-3 bg-secondary rounded-xl mb-4">
              ...
              <p className="text-[0.75rem] text-muted-foreground mt-0.5">
                {selectedDate.full} | {startTime} - {getEndTime()}
              </p>
              <p className="text-[0.9375rem] text-primary mt-1" style={{ fontWeight: 700 }}>
                ₹{total}
              </p>
            </div>
            ...
            <div className="space-y-2 mb-4">
              {[
                { id: "card", label: "Credit/Debit Card", detail: "**** 4242" },
                { id: "upi", label: "UPI", detail: "" },
                { id: "wallet", label: "PlugPoint Wallet", detail: "₹3,500" },
              ].map((m) => (
                <button
                  key={m.id}
                ...
                >
                  ...
                  <span className="text-[0.8125rem] flex-1 text-left" style={{ fontWeight: 500 }}>
                    {m.label}
                  </span>
                  {m.detail && (
            ...
            {/* Security Note */}
            <div className="flex items-center gap-2 p-2.5 bg-emerald-50 rounded-lg mb-4">
              <Shield className="w-4 h-4 text-primary" />
              <span className="text-[0.75rem] text-muted-foreground">
                Payment is held securely until your charging session completes
              </span>
            </div>
          ...
          <div className="p-4 text-center">
            ...
            <div className="mt-4 p-4 bg-secondary rounded-xl text-left">
              ...
              <div className="flex items-center gap-4 mt-3">
                <div>
                  <p className="text-[0.6875rem] text-muted-foreground">Date</p>
                  <p className="text-[0.8125rem]" style={{ fontWeight: 600 }}>
                    {selectedDate.full}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-[0.8125rem] text-primary" style={{ fontWeight: 700 }}>
                    ₹{total}
                  </p>
                </div>
              </div>
